...
confusionMatrix(data = test$Outcome, reference = factor(glm_pred)) #?No Information Rate : 0.7542   
...
#plot the changes in Cp,bic and adjR2 during selection,choose 4 varaibles as the best one
par(mfrow=c(1,3))
...
#glm_back<-glm(Outcome~Glucose+SkinThickness+DiabetesPedigreeFunction+Age,data=train,family="binomial")


#get best subset of the specified size with min cp.
# Create test model matrix with selected variables only, predcition, test error
